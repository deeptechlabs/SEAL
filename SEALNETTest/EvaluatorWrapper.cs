...
namespace SEALNETTest
{
    ...
    {
        [TestMethod]
        public void BFVEncryptNegateDecryptNET()
        {
        ...
        [TestMethod]
        public void BFVEncryptAddDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptSubDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptAddPlainDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptSubPlainDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptMultiplyPlainDecryptNET()
        {
            {
                var parms = new EncryptionParameters();
                var plain_modulus = new SmallModulus(1 << 6);
            ...
            {
                var parms = new EncryptionParameters();
                var plain_modulus = new SmallModulus((1UL << 20) - 1);
                parms.NoiseStandardDeviation = 3.19;
                parms.PlainModulus = plain_modulus;
                parms.PolyModulus = "1x^64 + 1";
                ...
                evaluator.MultiplyPlain(encrypted, plain);
                decryptor.Decrypt(encrypted, plain);
                Assert.AreEqual(0x5B05B058UL, encoder.DecodeUInt64(plain));
                Assert.AreEqual(encrypted.HashBlock, parms.HashBlock);
            }
            {
                var parms = new EncryptionParameters();
                var plain_modulus = new SmallModulus((1UL << 40) - 1);
                parms.NoiseStandardDeviation = 3.19;
                parms.PlainModulus = plain_modulus;
                parms.PolyModulus = "1x^64 + 1";
                parms.CoeffModulus = new List<SmallModulus> {
        ...
        [TestMethod]
        public void BFVEncryptMultiplyDecryptNET()
        {
            {
                var parms = new EncryptionParameters();
                var plain_modulus = new SmallModulus(1 << 6);
            ...
            {
                var parms = new EncryptionParameters();
                var plain_modulus = new SmallModulus((1UL << 60) - 1);
                parms.NoiseStandardDeviation = 3.19;
                parms.PlainModulus = plain_modulus;
                parms.PolyModulus = "1x^64 + 1";
                parms.CoeffModulus = new List<SmallModulus> {
                    DefaultParams.SmallMods60Bit(0),
                    DefaultParams.SmallMods60Bit(1),
                    DefaultParams.SmallMods60Bit(2) };
                var context = new SEALContext(parms);
                var keygen = new KeyGenerator(context);
                var encoder = new BalancedEncoder(plain_modulus);
        ...
        [TestMethod]
        public void BFVEncryptSquareDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptMultiplyManyDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptExponentiateDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
            parms.NoiseStandardDeviation = 3.19;
        ...
        [TestMethod]
        public void BFVEncryptAddManyDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(1 << 6);
        ...
        [TestMethod]
        public void BFVEncryptApplyGaloisDecryptNET()
        {
            var parms = new EncryptionParameters();
        ...
        [TestMethod]
        public void BFVEncryptRotateMatrixDecryptNET()
        {
            var parms = new EncryptionParameters();
            var plain_modulus = new SmallModulus(257);
            parms.NoiseStandardDeviation = 3.19;
