        ...
        namespace SEAL
        {
            ...
            void SmallModulus::Save(Stream ^stream)
            {
                ...
                try
                {
                    ...
                    Write(stream, reinterpret_cast<const char*>(modulus_->data()), bytes_per_uint64);
                    array<uint64_t, 3> const_ratio = modulus_->const_ratio();
            ...
            int SmallModulus::GetHashCode()
            {
                ...
                return ComputeArrayHashCode(modulus_->data(), modulus_->uint64_count());
            }
