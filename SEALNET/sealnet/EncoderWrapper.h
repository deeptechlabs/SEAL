...
namespace Microsoft
{
    namespace Research
    {
        namespace SEAL
        {
            ...
            and more generally they can be directly controlled by the preprocessor define SEAL_THROW_ON_DECODER_OVERFLOW
            ...
            */
            ...
            public:
                ...
                (represented by <see cref="BigUInt"/>).
                </remarks>
                <param name="plainModulus">The plaintext modulus (represented by <see cref="SmallModulus" />)</param>
                ...
                */
                BinaryEncoder(SmallModulus ^plainModulus);
                ...
                */
                Plaintext ^Encode(System::UInt64 value);
                ...
                */
                void Encode(System::UInt64 value, Plaintext ^destination);
                ...
                */
                Plaintext ^Encode(BigUInt ^value);
                ...
                */
                void Encode(BigUInt ^value, Plaintext ^destination);
                ...
                */
                Plaintext ^Encode(System::Int64 value);
                ...
                <exception cref="System::ArgumentNullException">if destination is null</exception>
                */
                void Encode(System::Int64 value, Plaintext ^destination);
                ...
                <exception cref="System::ArgumentException">if the output does not fit in System::UInt64 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                System::UInt64 DecodeUInt64(Plaintext ^plain);
                ...
                <param name="plain">The plaintext to be decoded</param>
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if the output does not fit in System::UInt32 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                System::UInt32 DecodeUInt32(Plaintext ^plain);
                ...
                <param name="plain">The plaintext to be decoded</param>
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if the output does not fit in System::Int64 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                System::Int64 DecodeInt64(Plaintext ^plain);
                ...
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if the output does not fit in System::Int32 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                System::Int32 DecodeInt32(Plaintext ^plain);
                ...
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if the output is negative (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                BigUInt ^DecodeBigUInt(Plaintext ^plain);
                ...
                <exception cref="System::ArgumentException">if the output is negative (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                void DecodeBigUInt(Plaintext ^plain, BigUInt ^destination);
                ...
                */
                ...
                <exception cref="System::ArgumentNullException">if destination is null</exception>
                */
                void Encode(System::Int32 value, Plaintext ^destination);
                ...
                <exception cref="System::ArgumentNullException">if destination is null</exception>
                */
                void Encode(System::UInt32 value, Plaintext ^destination);
            ...
            */
            ...
            public:
                ...
                plaintext modulus (represented by <see cref="SmallModulus"/>).
                </remarks>
                <param name="plainModulus">The plaintext modulus (represented by <see cref="SmallModulus" />)</param>
                <exception cref="System::ArgumentNullException">if plainModulus is null</exception>
                <exception cref="System::ArgumentException">if plainModulus is not at least 2</exception>
                */
                BalancedEncoder(SmallModulus ^plainModulus);

                /**
                <summary>Creates a BalancedEncoder object.</summary>
                <remarks>
                Creates a BalancedEncoder object. The constructor takes as input a reference to the plaintext modulus 
                (represented by <see cref="SmallModulus"/>), and an integer, at least 3, that is used as a base 
                in the encoding.
                </remarks>
                <param name="plainModulus">The plaintext modulus (represented by <see cref="SmallModulus" />)</param>
                ...
                */
                BalancedEncoder(SmallModulus ^plainModulus, System::UInt64 base);
                ...
                */
                BalancedEncoder(SmallModulus ^plainModulus, System::UInt64 base, MemoryPoolHandle ^pool);
            ...
            <seealso cref="BalancedFractionalEncoder">See BalancedFractionalEncoder for encoding using base-b representation for b
            greater than 2.</seealso>
            ...
            */
            ...
            public:
                ...
                parts</exception>
                */
                BinaryFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount);
                ...
                */
                ...
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if the integral part does not fit in System::Int64 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                double Decode(Plaintext ^plain);
            ...
            */
            ...
            public:
                ...
                parts</exception>
                */
                BalancedFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount);
                ...
                */
                BalancedFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, 
                    int fractionCoeffCount, System::UInt64 base);
                ...
                */
                ...
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if either the integral part does not fit in System::Int64 
            ...
            */
            ...
            public:
                ...
                <exception cref="System::ArgumentException">if plainModulus is not at least 2</exception>
                */
                IntegerEncoder(SmallModulus ^plainModulus);

                /**
                <summary>Creates an IntegerEncoder object.</summary>
                <remarks>
                Creates an IntegerEncoder object. The constructor takes as input a reference to the plaintext modulus 
                (represented by <see cref="SmallModulus"/>), and an integer, at least 2, that is used as a base in the encoding.
                </remarks>
                <param name="plainModulus">The plaintext modulus (represented by <see cref="SmallModulus" />)</param>
                ...
                <exception cref="System::ArgumentException">if plainModulus is not at least base</exception>
                */
                IntegerEncoder(SmallModulus ^plainModulus, System::UInt64 base);
            ...
            <seealso cref="BalancedFractionalEncoder">See BalancedFractionalEncoder for encoding using base-b representation for 
            b greater than 2.</seealso>
            ...
            */
            ...
            public:
                ...
                */
                FractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount);
