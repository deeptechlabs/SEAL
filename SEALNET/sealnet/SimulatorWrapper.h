...
namespace Microsoft
{
    namespace Research
    {
        ...
        {   
            ...
            work. The Simulation object together with <see cref="SimulationEvaluator"/> can 
            ...
            <para>
            Instances of Simulation can be manipulated using <see cref="SimulationEvaluator"/>, 
            ...
            <see cref="SimulationEvaluator"/>, simulations can be added, multiplied, subtracted,
            ...
            <seealso cref="SimulationEvaluator">See SimulationEvaluator for manipulating 
            ...
            */
            ...
            public:
                ...
                <exception cref="System::ArgumentException">if noiseBudget is not in the 
                valid range</exception>
                <exception cref="System::ArgumentException">if ciphertextSize is less 
                than 2</exception>
                <exception cref="System::ArgumentNullException">if parms is null</exception>
                */
                Simulation(EncryptionParameters ^parms, int ciphertextSize, int noiseBudget);
            ...
            <remarks>
            <para>
            Manipulates instances of <see cref="Simulation"/> with a public API similar 
            to how <see cref="Evaluator" /> manipulates ciphertexts. This makes existing 
            ...
            <para>
            <see cref="SimulationEvaluator" /> allows the user to simulate the effect of 
            ...
            <seealso cref="Simulation">See Simulation for the object modeling the noise in 
            ciphertexts.</seealso>
            */
            ...
            public:
                ...
                */
                ...
                coefficients in the underlying plaintext</param>
                <exception cref="System::ArgumentException">if plainMaxCoeffCount is negative
                or bigger than the degree of the polynomial modulus</exception>
                <exception cref="System::ArgumentException">if plainMaxAbsValue is bigger 
                than the plaintext modulus divided by 2</exception>
                <exception cref="System::ArgumentNullException">if parms is null</exception>
                */
                Simulation ^GetFresh(EncryptionParameters ^parms, int plainMaxCoeffCount,
                ...
                <param name="simulation">The <see cref="Simulation"/> object to
                negate</param>
                <exception cref="System::ArgumentNullException">if simulation is 
                null</exception>
                <exception cref="System::ArgumentException">if simulation has Size less 
                than 2</exception>
                <seealso cref="Evaluator::Negate(Ciphertext^)">See Evaluator::Negate() 
                ...
                */
                ...
                <param name="simulation1">The first <see cref="Simulation"/> object to
                add</param>
                <param name="simulation2">The second <see cref="Simulation"/> object to
                add</param>
                <exception cref="System::ArgumentNullException">if simulation1 or 
                simulation2 is null</exception>
                <exception cref="System::ArgumentException">if simulation1 and simulation2
                were constructed with different encryption
                parameters</exception>
                <exception cref="System::ArgumentException">if simulation1 or simulation2 
                has Size less than 2</exception>
                <seealso cref="Add(Ciphertext^,Ciphertext^)">See Evaluator::Add() for the 
                corresponding operation on ciphertexts.</seealso>
                */
                Simulation ^Add(Simulation ^simulation1, Simulation ^simulation2);

                /**
                <summary>Simulates noise budget consumption in Evaluator::AddMany() and 
                returns the result.</summary>

                <param name="simulations">The simulations to add</param>
                <exception cref="System::ArgumentNullException">if simulations or any of
                its elements is null</exception>
                <exception cref="System::ArgumentException">if simulations is 
                empty</exception>
                <exception cref="System::ArgumentException">if not all elements of 
                simulations were constructed with the same
                encryption parameters</exception>
                <exception cref="System::ArgumentException">if any of the elements in the
                simulation list has Size less than 2</exception>
                <seealso cref="Evaluator::AddMany(List<Ciphertext^>^)">See 
                Evaluator::AddMany() for the corresponding operation on 
                ciphertexts.</seealso>
                */
                ...
                <param name="simulation1">The <see cref="Simulation"/> object to 
                subtract from</param>
                <param name="simulation2">The <see cref="Simulation"/> object to
                subtract</param>
                <exception cref="System::ArgumentNullException">if simulation1 or 
                simulation2 is null</exception>
                <exception cref="System::ArgumentException">if simulation1 and simulation2
                ...
                <exception cref="System::ArgumentException">if simulation1 or simulation2 
                has Size less than 2</exception>
                <seealso cref="Evaluator::Sub(Ciphertext^,Ciphertext^)">See Evaluator::Sub() 
                for the corresponding operation on ciphertexts.</seealso>
                */
                ...
                <param name="simulation">The <see cref="Simulation"/> object to add
                to</param>
                <param name="plainMaxCoeffCount">An upper bound on the number of non-zero
                ...
                <exception cref="System::ArgumentException">if simulation has Size less
                than 2</exception>
                <exception cref="System::ArgumentException">if plainMaxCoeffCount is out
                of range</exception>
                <seealso cref="Evaluator::AddPlain(Ciphertext^,Plaintext^)">See 
                Evaluator::AddPlain() for the corresponding operation on 
                ciphertexts.</seealso>
                */
                Simulation ^AddPlain(Simulation ^simulation, int plainMaxCoeffCount, 
                    System::UInt64 plainMaxAbsValue);
                ...
                <param name="simulation">The <see cref="Simulation"/> object to subtract
                from</param>
                <param name="plainMaxCoeffCount">An upper bound on the number of non-zero 
                coefficients in the plain polynomial to multiply</param>
                ...
                <exception cref="System::ArgumentException">if plainMaxCoeffCount is out 
                of range</exception>
                <seealso cref="Evaluator::SubPlain(Ciphertext^,Plaintext^)">See
                Evaluator::SubPlain() for the corresponding operation on 
                ciphertexts.</seealso>
                */
                Simulation ^SubPlain(Simulation ^simulation, int plainMaxCoeffCount, 
                    System::UInt64 plainMaxAbsValue);
                ...
                <exception cref="System::ArgumentException">if simulation has Size less 
                than 2</exception>
                <exception cref="System::ArgumentException">if plainMaxCoeffCount is out of 
                range</exception>
                <exception cref="System::ArgumentException">if plainMaxCoeffCount or 
                plainMaxAbsValue is zero</exception>
                <seealso cref="Evaluator::MultiplyPlain(Ciphertext^,Plaintext^)">See 
                Evaluator::MultiplyPlain() for the corresponding operation on 
                ciphertexts.</seealso>
                */
                Simulation ^MultiplyPlain(Simulation ^simulation, int plainMaxCoeffCount, 
                    System::UInt64 plainMaxAbsValue);
                ...
                <exception cref="System::ArgumentNullException">if simulation1 or
                simulation2 is null</exception>
                <seealso cref="Evaluator::Multiply(Ciphertext^,Ciphertext^)">See 
                ...
                */
                ...
                <exception cref="System::ArgumentException">if simulation has Size less 
                than 2</exception>
                <seealso cref="Evaluator::Square(Ciphertext^)">See Evaluator::Square() 
                for the corresponding operation on ciphertexts.</seealso>
                */
                ...
                <param name="simulation">The <see cref="Simulation"/> object to raise 
                to a power</param>
                <param name="exponent">The power to raise the <see cref="Simulation"/> 
                object to</param>
                <exception cref="System::ArgumentNullException">if simulation is 
                null</exception>
                <exception cref="System::ArgumentException">if simulation has Size less 
                ...
                */
                ...
                /**
                <summary>Simulates noise budget consumption in Evaluator::MultiplyMany() 
                and returns the result.</summary>
                
                <param name="simulations">The list of <see cref="Simulation"/> objects to 
                multiply</param>
                <exception cref="System::ArgumentNullException">if simulations list or any
                of its elements is null</exception>
                <exception cref="System::ArgumentException">if simulations list is 
                empty</exception>
                <exception cref="System::ArgumentException">if at least two of the elements
                in the simulations list were constructed with different encryption 
                parameters</exception>
                <seealso cref="Evaluator::MultiplyMany(List<Ciphertext^>^)">See 
                Evaluator::MultiplyMany() for the corresponding operation on ciphertexts.</seealso>
                */
                ...
                <exception cref="System::ArgumentException">if simulation has Size less 
                than 2</exception>
                <seealso cref="Evaluator::Relinearize(Ciphertext^, EvaluationKeys^)">See 
                Evaluator::Relinearize() for the corresponding operation on
                ciphertexts.</seealso>
                */
                Simulation ^Relinearize(Simulation ^simulation, int decompositionBitCount);
