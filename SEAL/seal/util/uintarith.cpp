...
namespace seal
{
    namespace util
    {
        void multiply_uint_uint(const uint64_t *operand1, 
            int operand1_uint64_count, const uint64_t *operand2, 
            int operand2_uint64_count, int result_uint64_count, uint64_t *result)
        {
#ifdef SEAL_DEBUG
        ...
        void multiply_uint_uint64(const uint64_t *operand1,
            int operand1_uint64_count, uint64_t operand2, 
            int result_uint64_count, uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand1 == nullptr && operand1_uint64_count > 0)
            {
        ...
        void divide_uint_uint_inplace(uint64_t *numerator, 
            const uint64_t *denominator, int uint64_count, 
            uint64_t *quotient, MemoryPool &pool)
        {
            ...
            Pointer alloc_anchor(allocate_uint(2LL * uint64_count, pool));
        ...
        void divide_uint_uint_inplace(uint64_t *numerator, 
            const Modulus &denominator, int uint64_count, 
            uint64_t *quotient, MemoryPool &pool)
        {
#ifdef SEAL_DEBUG
            if (numerator == nullptr && uint64_count > 0)
        ...
        void exponentiate_uint(const uint64_t *operand, 
            int operand_uint64_count, const uint64_t *exponent, 
            int exponent_uint64_count, int result_uint64_count, 
            uint64_t *result, MemoryPool &pool)
        {
            ...
            Pointer big_alloc(allocate_uint(
                static_cast<int64_t>(result_uint64_count) + 
                result_uint64_count + 
                result_uint64_count, pool));
