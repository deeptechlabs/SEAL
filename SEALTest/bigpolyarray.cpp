...
namespace SEALTest
{
    ...
    public:
        TEST_METHOD(BigPolyArrayTest)
        {
            ...
            Assert::IsTrue("5x^4 + 4x^3 + 3x^2 + 2x^1 + 1" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(0)).to_string());
            Assert::IsTrue("8x^2 + 7x^1 + 6" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(1)).to_string());
            Assert::IsTrue("Ax^1 + 9" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(2)).to_string());
            ...
            Assert::IsTrue("5x^4 + 4x^3 + 3x^2 + 2x^1 + 1" == BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(0)).to_string());
            Assert::IsTrue("8x^2 + 7x^1 + 6" == BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(1)).to_string());
            Assert::IsTrue("Ax^1 + 9" == BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(2)).to_string());

            BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(1)).set_zero();
            Assert::IsTrue("5x^4 + 4x^3 + 3x^2 + 2x^1 + 1" == BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(0)).to_string());
            Assert::IsTrue("Ax^1 + 9" == BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(2)).to_string());
            ...
            Assert::IsTrue("3x^2 + 2x^1 + 1" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(0)).to_string());
            Assert::IsTrue("8x^2 + 7x^1 + 6" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(1)).to_string());
            ...
            Assert::IsTrue("1" == BigPoly(arr.coeff_count(), arr.coeff_bit_count(), arr.data(0)).to_string());
