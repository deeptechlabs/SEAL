    ...
    namespace util
    {
        ...
        public:
            ...
            TEST_METHOD(AddBigPolyArrayCoeffMod)
            {
                ...
                Modulus mod(coeff_modulus.data(), coeff_uint64_count, pool);

                // testing just addition, no mod reduction
                BigPolyArray result1(2, 5, 7);
                BigPolyArray arr1(2, 5, 7);
                BigPolyArray arr2(2, 5, 7);
                BigPoly(arr1.coeff_count(), arr1.coeff_bit_count(), arr1.data(0)) = "1x^1";
                BigPoly(arr1.coeff_count(), arr1.coeff_bit_count(), arr1.data(1)) = "1x^3";
                BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(0)) = "1";
                BigPoly(arr2.coeff_count(), arr2.coeff_bit_count(), arr2.data(1)) = "2x^1";
                add_bigpolyarray_coeffmod(arr1.data(0), arr2.data(0), 2, 5, mod, result1.data(0));
                Assert::IsTrue(BigPoly(result1.coeff_count(), result1.coeff_bit_count(), result1.data(0)).to_string() == "1x^1 + 1");
                Assert::IsTrue(BigPoly(result1.coeff_count(), result1.coeff_bit_count(), result1.data(1)).to_string() == "1x^3 + 2x^1");

                // expecting mod reduction
                BigPolyArray result2(3, 5, 7);
                BigPolyArray arr3(3, 5, 7);
                BigPolyArray arr4(3, 5, 7);
                BigPoly(arr3.coeff_count(), arr3.coeff_bit_count(), arr3.data(0)) = "1x^4 + A";
                BigPoly(arr3.coeff_count(), arr3.coeff_bit_count(), arr3.data(1)) = "3x^2 + 2x^1";
                BigPoly(arr3.coeff_count(), arr3.coeff_bit_count(), arr3.data(2)) = "Cx^1 + D";
                BigPoly(arr4.coeff_count(), arr4.coeff_bit_count(), arr4.data(0)) = "2x^4 + B";
                BigPoly(arr4.coeff_count(), arr4.coeff_bit_count(), arr4.data(1)) = "Fx^2 + 5x^1 + E";
                BigPoly(arr4.coeff_count(), arr4.coeff_bit_count(), arr4.data(2)) = "7x^1 + 8";
                add_bigpolyarray_coeffmod(arr3.data(0), arr4.data(0), 3, 5, mod, result2.data(0));
                Assert::IsTrue(BigPoly(result2.coeff_count(), result2.coeff_bit_count(), result2.data(0)).to_string() == "3x^4 + 5");
                Assert::IsTrue(BigPoly(result2.coeff_count(), result2.coeff_bit_count(), result2.data(1)).to_string() == "2x^2 + 7x^1 + E");
                Assert::IsTrue(BigPoly(result2.coeff_count(), result2.coeff_bit_count(), result2.data(2)).to_string() == "3x^1 + 5");
                ...
                BigPoly(singlepoly1.coeff_count(), singlepoly1.coeff_bit_count(), singlepoly1.data(0)) = "Ax^3 + Bx^2 + Cx^1 + D";
                BigPoly(singlepoly2.coeff_count(), singlepoly2.coeff_bit_count(), singlepoly2.data(0)) = "1x^3 + 2x^1 + 3";
                add_bigpolyarray_coeffmod(singlepoly1.data(0), singlepoly2.data(0), 1, 5, mod, result3.data(0));
                Assert::IsTrue(BigPoly(result3.coeff_count(), result3.coeff_bit_count(), result3.data(0)).to_string() == "Bx^3 + Bx^2 + Ex^1");

                // testing addition of zero BPA
                BigPolyArray result4(2, 5, 7);
                BigPolyArray testzero1(2, 5, 7);
                BigPolyArray testzero2(2, 5, 7);
                BigPoly(testzero1.coeff_count(), testzero1.coeff_bit_count(), testzero1.data(0)) = "1x^2 + 2x^1 + 3";
                BigPoly(testzero1.coeff_count(), testzero1.coeff_bit_count(), testzero1.data(1)) = "8x^3 + 9x^2 + Ax^1 + B";
                BigPoly(testzero2.coeff_count(), testzero2.coeff_bit_count(), testzero2.data(0)).set_zero();
                BigPoly(testzero2.coeff_count(), testzero2.coeff_bit_count(), testzero2.data(1)).set_zero();
                add_bigpolyarray_coeffmod(testzero1.data(0), testzero2.data(0), 2, 5, mod, result4.data(0));
                Assert::IsTrue(BigPoly(result4.coeff_count(), result4.coeff_bit_count(), result4.data(0)).to_string() == "1x^2 + 2x^1 + 3");
                Assert::IsTrue(BigPoly(result4.coeff_count(), result4.coeff_bit_count(), result4.data(1)).to_string() == "8x^3 + 9x^2 + Ax^1 + B");
                ...
                add_bigpolyarray_coeffmod(testbothzero1.data(0), testbothzero2.data(0), 3, 5, mod, result5.data(0));
                Assert::IsTrue(BigPoly(result5.coeff_count(), result5.coeff_bit_count(), result5.data(0)).to_string() == "0");
                Assert::IsTrue(BigPoly(result5.coeff_count(), result5.coeff_bit_count(), result5.data(1)).to_string() == "0");
                ...
                BigPoly(singlepoly3.coeff_count(), singlepoly3.coeff_bit_count(), singlepoly3.data(0)) = "1x^3 + 2x^2 + 3x^1 + 4";
                BigPoly(singlepoly4.coeff_count(), singlepoly4.coeff_bit_count(), singlepoly4.data(0)) = "5x^3 + 6x^1 + 7";
                add_bigpolyarray_coeffmod(singlepoly3.data(0), singlepoly4.data(0), 1, 5, mod, result6.data(0));
                Assert::IsTrue(BigPoly(result6.coeff_count(), result6.coeff_bit_count(), result6.data(0)).to_string() == "6x^3 + 2x^2 + 9x^1 + B");
            }
