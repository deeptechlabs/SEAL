...
namespace SEALTest
{
    ...
    public:
        TEST_METHOD(EmptyBigPoly)
        {
            ...
            Assert::IsTrue(nullptr == poly.data());
        ...
        TEST_METHOD(BigPoly3Coeff100Bits)
        {
            ...
            Assert::IsTrue("0" == poly.to_string());
            Assert::IsTrue(poly.is_zero());
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[4]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[5]);
            ...
            Assert::AreEqual(static_cast<uint64_t>(0x1234), poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[4]);
            ...
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(0x1234567812345678), poly.data()[4]);
            Assert::AreEqual(static_cast<uint64_t>(0x321), poly.data()[5]);
            ...
            Assert::AreEqual(3, poly.significant_coeff_count());
            Assert::AreEqual(static_cast<uint64_t>(0x123), poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(0x456), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(0x1234567812345678), poly.data()[4]);
            Assert::AreEqual(static_cast<uint64_t>(0x321), poly.data()[5]);
            ...
            Assert::AreEqual(1ULL, poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(2), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(3), poly.data()[4]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[5]);
            ...
            Assert::AreEqual(static_cast<uint64_t>(0x123), poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0x456), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(0x12345678), poly.data()[2]);
            ...
            Assert::AreEqual(static_cast<uint64_t>(0x456), poly.data()[2]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[3]);
            Assert::AreEqual(static_cast<uint64_t>(0x12345678), poly.data()[4]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[5]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[6]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[7]);
