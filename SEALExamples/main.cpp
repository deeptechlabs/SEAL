...
void example_performance_st()
{
    ...
    /*
    In this example we time all the basic operations in single-threaded 
    execution. We use the following lambda function to run the test.
    */
    ...
    for (int i = 0; i < th_count; i++)
    {
        ...
        */
        th_vector.emplace_back(
            performance_test_mt, i + 1, ref(print_mtx), MemoryPoolHandle::New()
        );
